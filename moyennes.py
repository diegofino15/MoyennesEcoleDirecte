...
def return_terminal(index):
    return f'''
 ___________________________________
|                                   |
|           Trimestre {index + 1}             |
|                                   |
|      Moyenne générale : {general_averages[index]}     |
|   Moyenne générale classe : {general_class_averages[index]} |
|                                   |
|   Français : {francais[index]}                |
|   Latin : {latin[index]}                   |
|   Anglais : {anglais[index]}                 |
|   Espagnol : {espagnol[index]}                |
|   Allemand : {allemand[index]}                |
|   Histoire-Géo : {histoire[index]}            |
|   EMC : {emc[index]}                     |
|   Maths : {maths[index]}                   |
|   Physique : {physique[index]}                |
|   SVT : {svt[index]}                     |
|   Techno : {techno[index]}                  |
|   Sport : {sport[index]}                   |
|   Arts-Pla : {arts[index]}                |
|   Musique : {musique[index]}                 |
|   Chorale : {chorale[index]}                 |
 ___________________________________
'''
